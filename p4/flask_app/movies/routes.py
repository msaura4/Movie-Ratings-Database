...
def user_detail(username):
    ...
    profile_pic = None
    if user.profile_pic:
        profile_pic = get_b64_img(username)

    return render_template("user_detail.html", user=user, reviews=reviews, profile_pic=profile_pic, error=None, image = profile_pic)
